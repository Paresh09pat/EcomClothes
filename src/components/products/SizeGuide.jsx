      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-xl mx-4 max-h-[95vh] overflow-y-auto">
          ...
          <div className="p-4 sm:p-6 text-center">
            <img src={"/sizeChart.webp"} alt="Size Chart" className="w-full h-auto max-w-full object-contain rounded-lg shadow-sm" />

            <button
              onClick={onClose}
              aria-label="Close size guide"
              className="mt-4 cursor-pointer px-4 py-2 rounded-md bg-gray-600 text-white text-sm font-medium 
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-xl mx-4 max-h-[95vh] overflow-y-auto">
        ...
        <div className="flex justify-center p-4 sm:p-6 border-t border-gray-200">
          <button
            onClick={onClose}
            className="px-6 py-2 bg-gray-600 text-white text-sm font-medium rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors cursor-pointer"
          >
            Close
          </button>
        </div>
